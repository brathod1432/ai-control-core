# Engineering Team Skills - an agent runtime Guidance
...
- **a11y-audit** â€” WCAG 2.2 accessibility audit and fix (a11y_scanner.py, contrast_checker.py)
- **azure-cloud-architect** â€” Azure infrastructure design, ARM/Bicep templates, landing zones
- **gcp-cloud-architect** â€” GCP infrastructure design, Terraform modules, cloud-native patterns
- **security-pen-testing** â€” Penetration testing methodology, vulnerability assessment, exploit analysis
- **snowflake-development** â€” Snowflake data warehouse development, SQL optimization, data pipeline patterns

**Security (5 skills):**
- **adversarial-reviewer** â€” Adversarial code review with 3 hostile personas (Saboteur, New Hire, Security Auditor)
- **threat-detection** â€” Hypothesis-driven threat hunting, IOC sweep generation, z-score anomaly detection
- **incident-response** â€” SEV1-SEV4 triage, 14-type incident taxonomy, NIST SP 800-61 forensics
- **cloud-security** â€” IAM privilege escalation paths, S3 public access checks, security group detection
- **red-team** â€” MITRE ATT&CK kill-chain planning, effort scoring, choke point identification
- **ai-security** â€” ATLAS-mapped prompt injection detection, model inversion & data poisoning risk scoring
...
â”œâ”€â”€ build.yml         # Build and lint
