...
description: "Adversarial code review that breaks the self-review monoculture. Use when you want a genuinely critical review of recent changes, before merging a PR, or when you suspect AI assistant is being too agreeable about code quality. Forces perspective shifts through hostile reviewer personas that catch blind spots the author's mental model shares with the reviewer."
tier: "STANDARD"
...
3. Note any **project conventions** from AI_RUNTIME_GUIDE.md, .editorconfig, linting configs, or existing patterns.
...
- **When AI assistant said "looks good"** â€” if you got an easy approval, run this for a second opinion
