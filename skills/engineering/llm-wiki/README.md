...
> **A second brain for an agent runtime + Obsidian.**
...
| **Vault templates** | `AI_RUNTIME_GUIDE.md`, `AGENTS.md`, `.cursorrules`, `index.md`, `log.md`, plus 5 page templates (entity, concept, source, comparison, synthesis) |
...
The scripts are pure Python stdlib â€” they run anywhere. Only the **schema loader** changes per tool:

| Tool | Loader file |
|---|---|
| an agent runtime | `AI_RUNTIME_GUIDE.md` |
| an agent runtime (OpenAI) | `AGENTS.md` |
| Cursor (modern) | `AGENTS.md` |
| Cursor (legacy) | `.cursorrules` |
| Antigravity (Google) | `AGENTS.md` |
| OpenCode / Pi | `AGENTS.md` |
| an agent runtime | `AGENTS.md` |
...
â”‚   â”œâ”€â”€ sources/            # one summary per ingested source
â”‚   â”œâ”€â”€ comparisons/        # cross-source analyses
â”‚   â””â”€â”€ synthesis/          # high-level overviews and theses
â”œâ”€â”€ AI_RUNTIME_GUIDE.md               # schema for an agent runtime
â”œâ”€â”€ AGENTS.md               # schema for Codex/Cursor/Antigravity
â””â”€â”€ .cursorrules            # (optional) legacy Cursor
```
...
- **Ingest** â€” Read a source, discuss with user, write summary page, update 5-15 cross-referenced pages, update index, log it
- **Query** â€” Read index first, drill into 3-10 pages, synthesize answer with inline citations, offer to file back as a new page
- **Lint** â€” Mechanical + semantic health check; surface contradictions, orphans, stale claims, cross-reference gaps
...
The wiki and RAG aren't opposites â€” RAG can sit on top of the wiki once you outgrow index-first search.

## Status

**v1.0.0** â€” initial release. SKILL + 3 agents + 5 commands + 8 scripts + 8 references + full vault templates + example vault.
...
- [Karpathy's original gist](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) â€” the pattern this plugin implements
- Vannevar Bush, "As We May Think" (1945) â€” the Memex
- [qmd](https://github.com/tobi/qmd) â€” local hybrid search over markdown (pair with this when the wiki outgrows `index.md`)
