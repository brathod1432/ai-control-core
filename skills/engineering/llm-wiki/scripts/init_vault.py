#!/usr/bin/env python3
"""
init_vault.py â€” Bootstrap an LLM Wiki vault.

Creates the three-layer structure (raw/, wiki/, schema files) and seeds it with
starter templates for AI_RUNTIME_GUIDE.md, AGENTS.md, index.md, log.md, and page templates.
...
The --tool flag controls which schema file(s) to install:
    claude-code  â†’ AI_RUNTIME_GUIDE.md (default)
    codex        â†’ AGENTS.md
    cursor       â†’ AGENTS.md + .cursorrules
    antigravity  â†’ AGENTS.md
    all          â†’ AI_RUNTIME_GUIDE.md + AGENTS.md + .cursorrules (recommended for multi-tool)
"""
...
TOOL_FILES = {
    "claude-code": ["AI_RUNTIME_GUIDE.md.template:AI_RUNTIME_GUIDE.md"],
    "codex": ["AGENTS.md.template:AGENTS.md"],
    "cursor": ["AGENTS.md.template:AGENTS.md", "integrations/platforms/cursor/templates/llm-wiki-cursor-rules.template:.cursorrules"],
    "antigravity": ["AGENTS.md.template:AGENTS.md"],
    "opencode": ["AGENTS.md.template:AGENTS.md"],
    "gemini-cli": ["AGENTS.md.template:AGENTS.md"],
    "all": [
        "AI_RUNTIME_GUIDE.md.template:AI_RUNTIME_GUIDE.md",
        "AGENTS.md.template:AGENTS.md",
        "integrations/platforms/cursor/templates/llm-wiki-cursor-rules.template:.cursorrules",
    ],
}
...
def init_vault(vault_path, topic, tool, force, as_json=False):
    ...
    # Schema files (AI_RUNTIME_GUIDE.md / AGENTS.md / .cursorrules)
    ...
    # .gitignore â€” exclude Obsidian workspace files
    ...
    print("     Layers:")
    print("       raw/          (your sources â€” immutable)")
...
def main():
    p = argparse.ArgumentParser(
        description="Initialize an LLM Wiki vault â€” the three-layer structure (raw/, wiki/, schema) Karpathy describes in the LLM Wiki gist.",
    )
