...
Flag this to the user â€” stale index means lint time.

### 5. Synthesize the answer
Format:
- **Direct answer** â€” 1-3 sentences
- **Supporting detail** â€” organized thematically
- **Inline citations** â€” `[[sources/xxx]]` wikilinks throughout; every claim links to its source
- **Related pages** â€” 3-5 wikilinks at the end
...
> `wiki/comparisons/<slug>.md` â€” or I can append it to an existing page._
...
- **Offer to file back** every substantive answer â€” but don't file trivial one-off answers.
...
- Answering without reading the index â†’ go back
- Citing only one source for a multi-source question â†’ broaden
- Inventing concepts not in the wiki â†’ stop and suggest ingestion
- Creating a new page for a trivial question â†’ don't pollute the wiki
