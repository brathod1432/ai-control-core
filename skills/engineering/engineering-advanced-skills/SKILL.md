...
description: "25 advanced engineering agent skills and plugins for an agent runtime, Codex, an agent runtime, Cursor, OpenClaw. Agent design, RAG, MCP servers, CI/CD, database design, observability, security auditing, release management, platform ops."
version: 1.1.0
...
### an agent runtime
```bash
npx agent-skills-cli add alirezarezvani/ai-ops-skills/engineering
```
