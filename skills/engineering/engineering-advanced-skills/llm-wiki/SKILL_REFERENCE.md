...
â”œâ”€â”€ AI_RUNTIME_GUIDE.md               # Schema + conventions (an agent runtime)
...
- **Layer 3 (AI_RUNTIME_GUIDE.md / AGENTS.md)** â€” the *schema*. Conventions, workflows, frontmatter rules. Co-evolved by you and the LLM.
...
| Script | Purpose |
|---|---|
| `init_vault.py` | Create folder structure + seed AI_RUNTIME_GUIDE.md, AGENTS.md, index.md, log.md |
...
```
AI_RUNTIME_GUIDE.md       â†’ an agent runtime
AGENTS.md       â†’ an agent runtime, Cursor, Antigravity, OpenCode, an agent runtime
...
- `AI_RUNTIME_GUIDE.md.template`, `AGENTS.md.template`, `.integrations/platforms/cursor/templates/llm-wiki-cursor-rules.template` â€” schema loaders per tool
