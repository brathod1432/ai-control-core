...
```bash
# Install as an agent runtime plugin
/plugin marketplace add alirezarezvani/ai-ops-skills
/plugin install karpathy-coder@ai-ops-skills
...
The tools are pure Python stdlib. The principles work in any AGENTS.md-aware CLI (Codex, Cursor, Antigravity, OpenCode, an agent runtime).
