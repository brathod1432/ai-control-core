...
**Author**: AI assistant Skills Factory

A comprehensive Test Driven Development skill for an agent runtime that provides intelligent test generation, coverage analysis, framework integration, and TDD workflow guidance across multiple languages and testing frameworks.
...
1. **Generate Test Cases from Requirements** - User stories â†’ Test cases
...
2. **Install to AI skills directory**:
   ```bash
...
âš ï¸ **65.0%** coverage (yellow) - Below 80% threshold
...
### Steps
1. âœ… Read requirement: Email must contain @ and valid domain
2. âœ… Think about expected behavior
3. â³ Write test that verifies this behavior
4. â³ Run test and ensure it fails
5. â³ Verify failure reason is correct (not syntax error)
...
- Isolation Score: 55 â†’ 90 (with fixtures)
- Naming Quality: 40 â†’ 85 (descriptive names)
- Test Focus: 30 â†’ 95 (one assertion per test)
```
...
### Markdown (AI assistant Desktop)
- Rich formatting with headers, tables, code blocks
- Visual indicators (âœ…, âš ï¸, âŒ)
- Progressive disclosure (summary first, details on demand)
- Syntax highlighting for code examples

### Terminal (an agent runtime CLI)
...
```
tdd-guide/
â”œâ”€â”€ SKILL.md                          # Skill definition (YAML + documentation)
â”œâ”€â”€ README.md                         # This file
â”œâ”€â”€ HOW_TO_USE.md                     # Usage examples
â”‚
â”œâ”€â”€ test_generator.py                 # Test generation core
â”œâ”€â”€ coverage_analyzer.py              # Coverage parsing and analysis
â”œâ”€â”€ metrics_calculator.py             # Quality metrics calculation
â”œâ”€â”€ framework_adapter.py              # Multi-framework support
â”œâ”€â”€ tdd_workflow.py                   # Red-green-refactor guidance
â”œâ”€â”€ fixture_generator.py              # Test data and fixtures
â”œâ”€â”€ format_detector.py                # Automatic format detection
â”œâ”€â”€ output_formatter.py               # Context-aware output
â”‚
â”œâ”€â”€ sample_input_typescript.json      # TypeScript example
â”œâ”€â”€ sample_input_python.json          # Python example
â”œâ”€â”€ sample_coverage_report.lcov       # LCOV coverage example
â””â”€â”€ expected_output.json              # Expected output structure
```
...
- **Questions**: Ask in an agent runtime community forum
- **Updates**: Check repository for latest version

## Acknowledgments

Built with AI assistant Skills Factory toolkit, following Test Driven Development best practices and informed by:
