#!/usr/bin/env python3
"""TC Init â€” Initialize TC tracking inside a project.
...
def detect_project_name(root: Path) -> str:
    """Try AI_RUNTIME_GUIDE.md heading, package.json name, pyproject.toml name, then directory basename."""
    claude_md = root / "AI_RUNTIME_GUIDE.md"
    if claude_md.exists():
        try:
