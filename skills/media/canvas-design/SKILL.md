...
- **Leave creative space**: Remain specific about the aesthetic direction, but concise enough that the next AI assistant has room to make interpretive choices also at a extremely high level of craftmanship.
...
- **ARTISTIC FREEDOM**: The next AI assistant interprets the philosophy visually - provide creative room
