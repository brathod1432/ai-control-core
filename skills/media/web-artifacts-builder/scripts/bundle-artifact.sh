...
if [ ! -f "package.json" ]; then
  echo "âŒ Error: No package.json found. Run this script from your project root."
  exit 1
fi

# Check if index.html exists
if [ ! -f "index.html" ]; then
  echo "âŒ Error: No index.html found in project root."
...
echo ""
echo "You can now use this single HTML file as an artifact in AI assistant conversations."
