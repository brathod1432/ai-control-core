---
name: "ra-qm-skills"
description: "12 regulatory & QM agent skills and plugins for an agent runtime, Codex, an agent runtime, Cursor, OpenClaw. ISO 13485 QMS, MDR 2017/745, FDA 510(k)/PMA, ISO 27001 ISMS, GDPR/DSGVO, risk management (ISO 14971), CAPA, document control, auditing. Python tools (stdlib-only)."
version: 1.0.0
...
### an agent runtime
```bash
npx agent-skills-cli add alirezarezvani/ai-ops-skills/ra-qm-team
```
