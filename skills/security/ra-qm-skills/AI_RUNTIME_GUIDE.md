# Regulatory Affairs & Quality Management Skills - an agent runtime Guidance
...
```
1. Risk Management (ISO 14971) â†’ risk-management-specialist
2. QMS Process Setup (ISO 13485) â†’ quality-manager-qms-iso13485
3. Technical Documentation (MDR) â†’ mdr-745-specialist
4. FDA Submission â†’ fda-consultant-specialist
5. Clinical Evaluation â†’ regulatory-affairs-head
```

### Workflow 2: QMS Audit Preparation

```
1. Internal Audit â†’ qms-audit-expert
2. CAPA Implementation â†’ capa-officer
3. Document Review â†’ quality-documentation-manager
4. Management Review â†’ quality-manager-qmr
5. Certification Audit â†’ qms-audit-expert
```

### Workflow 3: Data Protection Compliance

```
1. GDPR Assessment â†’ gdpr-dsgvo-expert
2. ISMS Implementation â†’ information-security-manager-iso27001
3. Security Audit â†’ isms-audit-expert
4. Continuous Monitoring â†’ information-security-manager-iso27001
```

## Integration Patterns

**RA/QM â†” Engineering:** Regulatory requirements inform technical design decisions

**RA/QM â†” Product:** Compliance requirements shape product features and roadmap

**RA/QM â†” Security:** ISO 27001 aligns with security engineering practices
