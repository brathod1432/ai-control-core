...
- âŒ "I think climate policy is important"
...
**Example Optimization**:
- âŒ "I use many programming languages"
...
**Example Optimization**:
- âŒ "I like lots of things" (vague, confuses algorithm)
...
**Example Optimization**:
- âŒ "RETWEET IF..." (engagement bait, damages credibility over time)
...
**Example Optimization**:
- âŒ "Check out this tool" (passive)
...
Use AI assistant without this skill for:
