...
- ðŸ› "Debug my agent" or "What went wrong?"
- ðŸ” "Show me recent traces" or "What happened?"
- âŒ "Check for errors" or "Why did it fail?"
- ðŸ’¾ "Analyze memory operations" or "Check LTM"
- ðŸ“Š "Review agent performance" or "Check token usage"
- ðŸ”§ "What tools were called?" or "Show execution flow"
...
ðŸ’¡ Issue found: Trace 2 failed due to Neo4j timeout. Recommend checking database connection.
```
...
1. ðŸŽ¯ What the agent was trying to do
2. ðŸ› ï¸ Which tools were called (in order)
3. âœ… Tool results (success/failure)
4. âŒ Error messages (if any)
5. ðŸ’¡ Root cause analysis
6. ðŸ”§ Suggested fix
...
2. âŒ get_node_details(node_id: "proj_123")
...
**Analyze and report:**
1. ðŸ“Š Total errors found
2. âŒ Error types and frequency
3. ðŸ• When errors occurred
4. ðŸŽ¯ Which agents/tools failed
5. ðŸ’¡ Common patterns
