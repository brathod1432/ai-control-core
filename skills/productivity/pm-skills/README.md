...
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management

# Install to an agent runtime only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management --agent claude

# Install to Cursor only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management --agent cursor
```
...
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/senior-pm

# Scrum Master Expert
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/scrum-master

# Atlassian Jira Expert
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/jira-expert

# Atlassian Confluence Expert
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/confluence-expert

# Atlassian Administrator
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/atlassian-admin

# Atlassian Template Creator
npx ai-agent-skills install alirezarezvani/ai-ops-skills/project-management/atlassian-templates
```
...
**Model Context Protocol (MCP)** enables direct integration with Jira and Confluence from an agent runtime.
...
Configure Atlassian MCP server in your an agent runtime settings with:
...
- **AI_RUNTIME_GUIDE.md:** `project-management/AI_RUNTIME_GUIDE.md` - an agent runtime specific guidance
- **Main Documentation:** `../AI_RUNTIME_GUIDE.md`
