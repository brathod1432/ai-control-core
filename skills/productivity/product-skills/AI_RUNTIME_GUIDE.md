# Product Team Skills - an agent runtime Guidance
...
**Purpose:** Automated OKR hierarchy (company â†’ product â†’ team)
...
**Purpose:** Product analytics â€” retention, cohort, and funnel analysis
...
**Features:**
- Risk Ã— uncertainty scoring for prioritization
...
**Note:** Requires `git` on PATH â€” must be run inside a git repository.
