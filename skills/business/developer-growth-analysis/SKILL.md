...
description: Analyzes your recent an agent runtime chat history to identify coding patterns, development gaps, and areas for improvement, curates relevant learning resources from HackerNews, and automatically sends a personalized growth report to your Slack DMs.
---
...
This skill provides personalized feedback on your recent coding work by analyzing your an agent runtime chat interactions and identifying patterns that reveal strengths and areas for growth.
...
1. **Reads Your Chat History**: Accesses your local an agent runtime chat history from the past 24-48 hours to understand what you've been working on.
...
Ask AI assistant to analyze your recent coding work:
