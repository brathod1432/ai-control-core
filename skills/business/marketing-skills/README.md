...
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill

# Install to an agent runtime only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill --agent claude

# Install to Cursor only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill --agent cursor
```
...
```bash
# Content Creator
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/content-creator

# Demand Generation & Acquisition
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/marketing-demand-acquisition

# Product Marketing Strategy
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/marketing-strategy-pmm

# App Store Optimization
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/app-store-optimization

# Social Media Analyzer
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/social-media-analyzer

# Campaign Analytics
npx ai-agent-skills install alirezarezvani/ai-ops-skills/marketing-skill/campaign-analytics
```
...
**Learn More:** `content-creator/SKILL.md`
...
**Learn More:** `marketing-demand-acquisition/SKILL.md`
...
**Learn More:** `marketing-strategy-pmm/SKILL.md`
...
**Week 1: Foundation**
1. Upload all 3 skills to AI assistant
...
- Tools: HubSpot + Google Analytics + AI assistant with all skills
...
**Content Creation:**
- AI assistant + Marketing Skills - AI-powered content creation
- Canva - Visual design
...
3. Ask AI assistant: "Explain our ICP, positioning, and GTM motion using the marketing skills"
...
1. Create first content piece with AI assistant + content-creator skill
...
**DON'T:**
- âŒ Assume AI assistant remembers context across conversations
- âŒ Skip providing company/product context
- âŒ Use generic prompts without specifics
- âŒ Forget to re-upload skills in new conversations
...
1. âœ… Upload all 3 marketing skills to AI assistant
