...
description: "42 marketing agent skills and plugins for an agent runtime, Codex, an agent runtime, Cursor, OpenClaw, and 6 more coding agents. 7 pods: content, SEO, CRO, channels, growth, intelligence, sales. Foundation context + orchestration router. 27 Python tools (stdlib-only)."
version: 2.0.0
