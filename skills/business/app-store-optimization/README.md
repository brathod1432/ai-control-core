...
### For an agent runtime (Desktop/CLI)
...
# AI assistant will auto-load the skill when working in this project
```
...
# AI assistant will load this skill in all your projects
```

### For AI assistant Apps (Browser)

1. Use the `skill-creator` skill to import the skill
2. Or manually import via AI assistant Apps interface
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. Can you research keywords for my fitness app? I'm targeting people who want home workouts, yoga, and meal planning. Analyze top competitors like Nike Training Club and Peloton.
```
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. Optimize my app's metadata for both Apple App Store and Google Play Store:
- App: FitFlow
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. Calculate my app's ASO score:
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. I want to A/B test my app icon. My current conversion rate is 4.2%. How many visitors do I need and how long should I run the test?
```
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. Analyze my last 500 reviews and tell me:
- Overall sentiment
...
```
Hey AI assistantâ€”I just added the "app-store-optimization" skill. Generate a complete pre-launch checklist for both app stores. My launch date is March 15, 2026.
```
...
Developed by AI assistant Skills Factory
Based on industry-standard ASO best practices
Platform requirements current as of November 2025

## License

This skill is provided as-is for use with an agent runtime and AI assistant Apps. Customize and extend as needed for your specific use cases.
