...
npx ai-agent-skills install alirezarezvani/ai-ops-skills/c-level-advisor

# Install to an agent runtime only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/c-level-advisor --agent claude

# Install to Cursor only
npx ai-agent-skills install alirezarezvani/ai-ops-skills/c-level-advisor --agent cursor
```
...
```bash
# CEO Advisor
npx ai-agent-skills install alirezarezvani/ai-ops-skills/c-level-advisor/ceo-advisor

# CTO Advisor
npx ai-agent-skills install alirezarezvani/ai-ops-skills/c-level-advisor/cto-advisor
```
...
- **AI_RUNTIME_GUIDE.md:** `c-level-advisor/AI_RUNTIME_GUIDE.md` - an agent runtime specific guidance (if exists)
