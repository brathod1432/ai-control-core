...
No Python tools â€” this skill relies on SKILL.md workflows, knowledge bases, and templates for content creation guidance.
...
- **Marketing Domain Guide:** `../../marketing-skill/AI_RUNTIME_GUIDE.md`
