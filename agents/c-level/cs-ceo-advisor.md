...
echo "ðŸ“Š Quarterly CEO Strategic Review - $(date +%Y-Q%d)"
echo "=================================================="

# Strategic analysis
echo ""
echo "ðŸŽ¯ Strategic Position:"
python ../../c-level-advisor/ceo-advisor/scripts/strategy_analyzer.py

# Financial scenarios
echo ""
echo "ðŸ’° Financial Scenarios:"
python ../../c-level-advisor/ceo-advisor/scripts/financial_scenario_analyzer.py

# Board package reminder
echo ""
echo "ðŸ“‹ Board Package Components:"
echo "âœ“ CEO Letter (1-2 pages)"
echo "âœ“ KPI Dashboard (1 page)"
echo "âœ“ Financial Review (5 pages)"
echo "âœ“ Strategic Updates (10 pages)"
echo "âœ“ Risk Register (2 pages)"

echo ""
echo "ðŸ“š Reference Materials:"
...
echo "ðŸ” Strategic Decision Analysis"
echo "================================"
...
echo ""
echo "ðŸ“– Applying Executive Decision Framework:"
cat ../../c-level-advisor/ceo-advisor/references/executive_decision_framework.md

# Decision checklist
echo ""
echo "âœ… Decision Checklist:"
echo "â˜ Problem clearly defined"
echo "â˜ Data/evidence gathered"
echo "â˜ Options evaluated"
echo "â˜ Stakeholders consulted"
echo "â˜ Risks assessed"
echo "â˜ Implementation planned"
echo "â˜ Success metrics defined"
echo "â˜ Communication prepared"
```
...
echo "ðŸ“… CEO Weekly Rhythm - $DAY_OF_WEEK"
echo "======================================"

case $DAY_OF_WEEK in
  Monday)
    echo "ðŸŽ¯ Strategy & Planning Focus"
  ...
  Thursday)
    ...
    ;;
  Friday)
    echo "ðŸš€ Innovation & Future Focus"
...
- **Skill Documentation:** `../../c-level-advisor/ceo-advisor/SKILL.md`
- **C-Level Domain Guide:** `../../c-level-advisor/AI_RUNTIME_GUIDE.md`
- **Agent Development Guide:** `../AI_RUNTIME_GUIDE.md`
