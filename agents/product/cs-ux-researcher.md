...
- **Primary Skill:** `../../product-team/ux-researcher-designer/SKILL.md`
- **Interview Analyzer:** `../../product-team/product-manager-toolkit/SKILL.md`
...
- **Design System:** `../../product-team/ui-design-system/SKILL.md`
- **Product Domain Guide:** `../../product-team/AI_RUNTIME_GUIDE.md`
