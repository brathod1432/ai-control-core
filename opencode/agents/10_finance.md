...
2. You may read:
   - `BD_README.md` (project root) — current phase (MVP/Beta/Production) and pricing tiers for context
...
Return your financial report JSON to brijesh-dev. It updates the "Current Status" section of `BD_README.md` with health score and logs the report in `BD_changelog.md`. If this is the first analysis, brijesh-dev saves the baseline to `.opencode/skills/finance-baseline.md` for future comparisons.
