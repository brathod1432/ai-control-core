...
2. Read `BD_README.md` (project root) — check what has already been built and which agents have been used, to avoid re-doing completed work
3. Read `.opencode/memory/context.md` — project constraints that affect which agents to schedule
