...
2. You may read:
   - `BD_README.md` (project root) — product one-liner and target customer
...
Return your email sequence JSON to brijesh-dev. It logs the output in `BD_changelog.md` and can save successful templates to `.opencode/skills/email-<sequence-name>.md` for reuse.
