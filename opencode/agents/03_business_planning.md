...
2. You may read:
   - `BD_README.md` (project root) — existing decisions and target customer definition that must be consistent
...
Return your business plan JSON to brijesh-dev. It appends the key decisions to `.opencode/memory/decisions.md` and updates `BD_README.md`.
