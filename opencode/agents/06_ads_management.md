...
2. You may read:
   - `BD_README.md` (project root) — product name, one-liner, and pricing (for ad copy)
...
Return your campaign JSON to brijesh-dev. It logs the output in `BD_changelog.md` and saves channel decisions to `.opencode/memory/decisions.md`.
