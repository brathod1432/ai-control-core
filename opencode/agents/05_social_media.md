...
2. You may read:
   - `BD_README.md` (project root) — product name, overview, and target customer
   - `.opencode/memory/context.md` — brand voice guidelines if any have been saved
   - `.opencode/skills/social-voice.md` — if saved, use the established tone and style

Return your content JSON to brijesh-dev. It handles all file writes and logs the output in `BD_changelog.md`.
