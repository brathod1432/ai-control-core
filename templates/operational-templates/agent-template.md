...
domain: domain-name
model: model-or-runtime-profile
...
<!--
  ...
  1. Replace "agent-name" with your agent's name (use kebab-case)
  ...
  - agents/marketing/demand-gen-specialist.md
  - agents/c-level/ceo-advisor.md
  - agents/c-level/cto-advisor.md
...
- **Domain Guide:** `../../context/SKILLS_INDEX.md`
