# Templates - an agent runtime Guidance
...
```bash
# 1. Copy template
cp templates/operational-templates/agent-template.md agents/domain/new-agent.md

# 2. Customize for your agent
vim agents/domain/new-agent.md
...
git commit -m "feat(agents): implement new-agent from template"
```

## Related Documentation

- **Agent Development:** `../../agents/README.md` - Generic agent creation guidance
- **Standards:** `../../standards/README.md` - Quality and consistency standards
- **Runtime Rules:** `../../rules/AI_RUNTIME_RULES.md` - Generic AI runtime rules
