...
AI_RUNTIME_GUIDE.md           # Repository root (UPPERCASE)
...
# Linked image
`![Alt text`](https://link-destination.com)
...
repository_root:
  ...
  AI_RUNTIME_GUIDE.md:
    ...
    audience: "an agent runtime and developers"
...
- âœ… Write for the target audience
- âœ… Use clear, simple language
- âœ… Provide concrete examples
- âœ… Include screenshots where helpful
...
- âŒ Assume prior knowledge
- âŒ Use jargon without explanation
- âŒ Write vague instructions
- âŒ Skip error scenarios
- âŒ Let docs get stale
- âŒ Use "click here" as link text
- âŒ Skip proofreading
- âŒ Forget about mobile users
