# Standards Library - an agent runtime Guidance
...
**Best Practices:**
- Keep runtime guide files concise and scoped
- Markdown formatting standards (headings, lists, code blocks)
- Living documentation (`README.md`, context files, and runtime guides updated regularly)
...
- **Domain skills:** See `../../context/SKILLS_INDEX.md`
